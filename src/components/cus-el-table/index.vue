<template>
  <div class="tb-container">
    ...
    >
      <template #buttons>
        <div class="search-buttons">
          <el-button type="primary" class="primary-blue" @click="handleSearch">
            <el-icon><i-ep-search /></el-icon>
            <!-- <Icon icon="ep:search" /> -->
          </el-button>
          <el-button type="warning" class="primary-orange" @click="searchReset">
    ...
    <div class="header-buttons">
      <slot name="tableHeader" :rows="selectedList" :ids="selectedListIds" :is-selected="isSelected" />
