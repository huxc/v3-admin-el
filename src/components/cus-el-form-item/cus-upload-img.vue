...
.upload-image .el-dialog__header {
 ...
 .upload-image .el-dialog__header .el-dialog__headerbtn { background-color: transparent !important;}
 .upload-image .el-dialog__body{max-height: 500px;overflow-y: auto;}
.cus-upload-x {
